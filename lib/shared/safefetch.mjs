...
// Said once, loudly: with the flag on there is NO address check and NO pinning.
if (process.env.AP_ALLOW_PRIVATE_TARGETS === '1') {
  console.warn('safefetch: AP_ALLOW_PRIVATE_TARGETS=1 — SSRF protection is OFF. '
    + 'Local federation testing only; never set this on a networked deployment.');
}
