...
export function apUrls(remotePod, root = 'activitypods-js/') {
  ...
  return {
    ...
    pendingFollowers: home + 'ap/private/pending-followers',
    pendingFollowing: home + 'ap/private/pending-following',
    blocked: home + 'ap/private/blocked',
...
export function actorDoc({ urls, handle, name, publicKeyPem, movedTo = null, kind = 'person',
  ...
  webId = null, moderators = null, pendingFollowers = null, pendingFollowing = null,
