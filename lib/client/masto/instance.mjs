...
export function tagObject(api, name, following, req, history = []) {
...
// The Mastodon API version this facade answers to. Clients read it for what
// the server can do beyond the version string: grouped notifications from 2,
// a filter's blur action from 5, quote posts from 7. Everything up to 7 is
// served here; nothing past it is claimed.
