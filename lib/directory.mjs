...
// this machine, whatever ports they actually run on. Loopback only. Held only
// by a CONFIGURED agent: an unconfigured one's record page is a setup form
// with no identity list, which strands whoever the door sends there.
//
...
export function claimDirectory({ port, origin, log = () => {}, eligible = () => true }) {
