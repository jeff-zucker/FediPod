...
/**
 * The private half: the home itself, the state container, and the RDF tree
 * when it lives on the pod rather than beside the agent.
 *
 ...
 */
export async function provisionPrivate(pod, urls, { fediverse = true } = {}) {
