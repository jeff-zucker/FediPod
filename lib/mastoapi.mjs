...
export class MastoApi {
  ...
  // Every agent used to report title 'activitypod-js', so a client holding two
  ...
  instanceTitle() {
    ...
    return cfg?.handle ? `@${cfg.handle}@${this.host}` : 'activitypod-js';
  }
  ...
  async handle(req, res, pathname, url) {
    ...
    if (pathname === '/api/v1/instance') {
      return send(200, {
        ...
        description: this.instanceBlurb(), email: '', version: '4.2.0 (compatible; activitypod-js)',
    ...
    if (pathname === '/api/v2/instance') {
      return send(200, {
        domain: this.host, title: this.instanceTitle(), version: '4.2.0 (compatible; activitypod-js)',
        source_url: 'https://github.com/jeff-zucker/activitypod-js', description: this.instanceBlurb(),
    ...
    if (pathname === '/api/v1/timelines/home' || pathname === '/api/v1/timelines/public'
      ...
      let items = this.store.getStatuses()
        ...
        // (mentions remain in notifications and /api/v1/statuses)
    ...
    if (pathname === '/api/v2/search' || pathname === '/api/v1/search') {
      ...
      if (asHandle && type !== 'statuses') {
        ...
        if (doc?.type === 'Person' && doc.id) out.accounts.push(this.account(doc.id));
          ...
          if (!s) {
            s = {
              noteId: doc.id, actor: doc.attributedTo, content: sanitizeHtml(doc.content),
