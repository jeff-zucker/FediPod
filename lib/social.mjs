...
export async function admitRequest(agent, actor) {
  ...
  await agent.publisher.publishCollections({ followers: true, pending: true });
...
// nothing is delivered — the blocked actor is the one party who must not be
// notified (§6.10). Intake already refuses a blocked author on arrival.
