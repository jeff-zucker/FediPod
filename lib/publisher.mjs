...
export class Publisher {
  ...
  async ensureMediaContainer() {
    ...
    if (await this._containerExists(this.urls.media)) { this._mediaReady = true; return; }
  ...
  async ensurePrivateContainer() {
    ...
    if (await this._containerExists(this.urls.privateNotes)) { this._privateContainer = true; return; }
