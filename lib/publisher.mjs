...
export class Publisher {
  ...
  async updateNote(s, { content, spoilerText = null, attachments = null } = {}) {
    ...
    // A recovered post may carry no slug; the note id already contains it.
    const slug = s.slug || String(s.noteId).slice(urls.notes.length);
