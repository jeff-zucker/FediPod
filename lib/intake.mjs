...
export class Intake {
  constructor({ config, urls, remote, local, store, deliverer, publisher, log = console.log, lease = null, archive = null }) {
    Object.assign(this, { config, urls, remote, local, store, deliverer, publisher, log, lease, archive });
