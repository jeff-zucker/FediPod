...
import { USER_AGENT, AGENT_VERSION } from '../../shared/ua.mjs';
...
// The version is read where a bundled deploy (the Netlify functions) cannot
// break it: a package.json that is not beside the bundle is not a reason for
// the gateway to fail to start (2026-09-26).
