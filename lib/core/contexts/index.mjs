...
// Not from fedify either. Pleroma and Akkoma name a copy of the litepub schema
// served by each instance itself, at /schemas/litepub-0.1.jsonld; every copy
// is the same document, and this is one of them. It is what declares
// EmojiReact, and the older quote spellings quoteUrl and quoteUri. Held under
// the litepub namespace, since no one URL names it; groundContext maps a
// per-instance URL onto this entry.
import ctx15 from './litepub-0.1.json' with { type: 'json' };
// The quote terms as Mastodon declares them inline on a post: FEP-044f's
// quote, quoteAuthorization, QuoteRequest and QuoteAuthorization, and
// Misskey's _misskey_quote. No document at the FEP's URL serves a context;
// the key is what lets the terms be named when reading.
import ctx16 from './quotes.json' with { type: 'json' };
...
export const CONTEXTS = {
  ...
  'http://litepub.social/ns': ctx15,
  'https://w3id.org/fep/044f': ctx16,
};
