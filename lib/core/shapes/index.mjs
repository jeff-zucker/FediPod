...
/**
 * What to call the property that did not fit.
 *
 * A single-predicate path names itself: the IRI, shortened. A sequence path is
 * a list, and its head is a blank node that names nothing — so the failing
 * property shape is asked for its own `sh:name` instead.
 */
