...
// can drive it. Same order, same decisions as `solid-activitypub setup` always had:
...
// (bin/solid-activitypub.mjs, the address preview) — as data, so the page can show
