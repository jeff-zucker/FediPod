// sanitize-html 2.17.7 with its dependencies, packed by scripts/vendor-sanitize.mjs. Do not edit.
...
var require_launder = __commonJS({
  "node_modules/launder/index.js"(exports2, module2) {
    ...
    module2.exports = function(options) {
      ...
      self2.tags = function(tags, filter3) {
        ...
        const rewritten = strings.map(filter3 || self2.filterTag);
